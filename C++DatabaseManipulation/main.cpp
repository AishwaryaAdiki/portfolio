...
int main()
{
    ...
    batchFile.open ("update1.txt", ios::in);
    logFile.open ("freeplay1.log", ios::app);
    databaseFile.open ("freeplay1.dat", ios::out| ios::in | ios::ate | ios::binary);
    ...
    while (!batchFile.eof())
    {
        ...
        if (inputLine[0] == '1')
        {
            addRecord(inputLine, databaseFile, logFile);
        }
        else if (inputLine[0] == '2')
        {
            searchRecord(inputLine, databaseFile, logFile);
        }
        else if (inputLine[0] == '3')
        {
            editRecord(inputLine, databaseFile, logFile);
        }
        else if (inputLine[0] == '4')
        {
            deleteRecord(inputLine, databaseFile, logFile, newDatabaseFile);
...
void addRecord (string inputLine, fstream &databaseFile, fstream &logFile)
{
    ...
    databaseFile << endl << name << ", "; //added the name to freeplay.databaseFile
    ...
    size_t thirdspace = inputLine.find(' ', secondspace + 1);
    ...
    databaseFile << setfill('0') << setw(9) << highscore << ", ";
    logFile << "Highscore: " << highscore << endl;
    ...
    databaseFile << setfill('0') << setw(4) << plays << ", ";
    ...
    databaseFile << "$" << setfill('0') << setw(7) << setprecision (2) << revenue ;
...
void deleteRecord (string inputLine, fstream &databaseFile, fstream &logFile, fstream &newDatabaseFile)
{
    ...
    char newFilename[] ="freeplay1.dat";
...
void editRecord (string inputLine, fstream &databaseFile, fstream &logFile)
{
    databaseFile.open ("freeplay1.dat", ios::out| ios::in | ios::ate | ios::binary);
    string editName;
    ...
    databaseFile.seekp(finalmarker, ios::beg);
    
    databaseFile << setfill('0') << setw(9) << editHighscore;
...
void searchRecord (string inputLine, fstream &databaseFile, fstream &logFile)
{
    databaseFile.open ("freeplay1.dat", ios::out| ios::in | ios::ate | ios::binary);
    ...
    while (!databaseFile.eof())
    {
        getline(databaseFile, searchline);
